...
namespace GMail.Contracts
{
    public class SendEmailRequest
    {
        ...
        [JsonProperty("thread_id"),JsonPropertyName("thread_id")]
        public string ThreadId { get; set; }

        [JsonProperty("in_reply_to_id"),JsonPropertyName("in_reply_to_id")]
        public string InReplyToId { get; set; }

        [JsonProperty("references_id"),JsonPropertyName("references_id")]
